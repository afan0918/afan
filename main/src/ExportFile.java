...
public class ExportFile extends javax.swing.JFrame {
    ...
    private void SaveLRModel(String Path, ArrayList<int[]> combinations, ArrayList<Double> FScore, ArrayList<Double> Sensitivity, ArrayList<Double> Specificity, String[] DataTitle, ArrayList<double[]> weight){
    ...
    private void SaveSVMModel(String Path, ArrayList<int[]> combinations, ArrayList<Double> FScore, ArrayList<Double> Sensitivity, ArrayList<Double> Specificity, String[] DataTitle, ArrayList<double[]> weight, ArrayList<Double> Bias) {
        BufferedWriter fw = null;
        try {
            fw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(Path, true), StandardCharsets.UTF_8)); // 指定編碼格式，以免中文字符異常
